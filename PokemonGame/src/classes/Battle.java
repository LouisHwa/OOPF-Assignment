...
public class Battle {
    ...
    public Pokemon[] wildPokemon() {
		...
		System.out.println("======= Your voice summoned 2 wild pokemons! =======");
    ...
    public Player battlingDynamic(Player currentPlayer, ArrayList<Pokemon> userPokemons, ArrayList<Pokemon> wildPokemons, Environment stadium) {
    	...
    	if (team1.isEmpty()) {
            System.out.println("All your Pokemon have fallen! Wild Pokemon win!");
            score = 0;
            medal = 0;
        } else {
            System.out.println("All wild Pokemon have fallen! You win!");
		...
		if (!team1.isEmpty()) {
			System.out.println("Time to catch the wild pokemons!");
